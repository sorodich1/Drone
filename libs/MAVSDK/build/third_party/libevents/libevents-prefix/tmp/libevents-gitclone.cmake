...
if(error_code)
  message(FATAL_ERROR "Failed to clone repository: 'https://github.com/mavlink/libevents.git'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to checkout tag: '7c1720749dfe555ec2e71d5f9f753e6ac1244e1c'")
endif()
