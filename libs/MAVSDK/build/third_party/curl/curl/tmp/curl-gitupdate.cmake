...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "curl-8_16_0"
  WORKING_DIRECTORY "/home/pi/Drone/libs/MAVSDK/build/third_party/curl/curl/src/curl"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("curl-8_16_0" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: curl-8_16_0")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/curl-8_16_0")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"curl-8_16_0\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/pi/Drone/libs/MAVSDK/build/third_party/curl/curl/src/curl'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/pi/Drone/libs/MAVSDK/build/third_party/curl/curl/src/curl'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
